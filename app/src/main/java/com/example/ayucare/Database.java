...
public class Database extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String qry2 = "create table users(username text,phoneno text,email text,password text)";
...
//    public void fpassword(String email,String otp){
//        int result=0;
//        String str[] = new String[2];
//        str[0]=email;
//        str[1]=otp;
//        SQLiteDatabase db = getWritableDatabase();
//        Cursor c = db.rawQuery("select * from users where email=? and otp=? ",str);
//        if(c.moveToFirst()){
//            result=1;
//        }
//
//    }
    public void register(String username, String phoneno, String email, String password){
    ...
    public int chackAppointmentExists(String username,String fullname,String address,String contact,String date,String time){
        int result = 0;
